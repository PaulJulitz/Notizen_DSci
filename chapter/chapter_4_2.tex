...
\begin{figure}[H]
	...
	\caption{Key components of the four responsibilities}
\end{figure}

However, this is not about \gls{p_LR} in the traditional sense, where an organizational unit is managed to ensure the stability of output flows. Rather, it focuses on creating a coherent organizational framework that manages expectations towards others and oneself, allowing a group of individuals to focus on realizing a vision based on their abilities and preferences, by working together as a team.\\

As with most frameworks, this is a starting point and does not claim to be definitively correct. However, it should serve as a \gls{p_CDF} when striving to enable a group to consistently provide the best possible solutions and move forward with the vision. Thus, it requires scrutiny from all perspectives.

\paragraph{Group of People or Team}
All four categories of responsibility are written with a team in mind.\\

However, while addressing this topic in the first place, other group dynamics such as alliances, collaborations, and various social dependencies (e.g., expectations, managing the inflow and outflow of members, decision-making responsibilities, etc.) were also considered. The first draft of this rubric (see \ref{sec:Rubric}) failed to establish clear boundaries regarding what constitutes a team and how these principles can be applied across different situations and group structures. For you as a reader, you may consider how these principles transcend the concept of a team and their applicability to a more general term: group of people. Therefore, careful thought is required when applying the \gls{p_LR} in a given situation.

...
\newglossaryentry{p_PHSI}{
	type=\acronymtype,
	name={PHSI},
	description={
		Payed Hierachy with Social Impact
	},
	first={
		\glsentrydesc{p_PHSI} (\glsentrytext{p_PHSI})
	}
}


\newglossaryentry{p_HoZHeiT}{
	type=\acronymtype,
	name={HoZHe(i)t},
	description={
		Homegen in der Sache / Zielsetzung, Heterogen als Team (Vorschlag von Franziska)
	},
	first={
		\glsentrydesc{p_ HoZHeiT} (\glsentrytext{p_ HoZHeiT})
	}
}

\newglossaryentry{p_LR}{
	type=\acronymtype,
	name={LR},
	description={
		Leadership Responsibilities/Responsibility
	},
	first={
		\glsentrydesc{p_LR} (\glsentrytext{p_LR})
	}
}
...
\newglossaryentry{p_PRE-WTC}{
	...
	name={PRE-WTC},
	description={
		Principals, Responsibilities, Expectations - when Working Together on a Challenge, see for more detail the \textit{Rubric section}.
		% The PRE-WTC
	...
	first={
		\glsentrydesc{p_PRE-WTC} (\glsentrytext{p_PRE-WTC})
	}
}

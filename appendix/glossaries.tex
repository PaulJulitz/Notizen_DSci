...
\newglossaryentry{g_Kernel_Jy}{
	...
	description={
		The kernel is in general a the engine to excute the markdown and compute commands in a Jupyter Notebook (web-interface).
	}
}
...
\newglossaryentry{g_ipynb}{
	name={Jupyter Notebook (.ipynb)},
	description={
		A Jupyter Notebook is a web-interface for Python.
	}
}
